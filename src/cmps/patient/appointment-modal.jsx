      ...
      <Box sx={style} className="delete">
        <div>
          ...
          <div className="modal-info-continer flex column justify-center align-center">
              <Box sx={{ minWidth: 400 }}>
                  <div className='appoint-modal-title'><h2>Make an appointment</h2> </div>
            <div className="type-of-treatment-selector">
                ...
                </div><div className="to-doctor-selector">
                <FormControl fullWidth disabled={!treatmentType}>
                  <InputLabel id="to-doctor">
                    To
                  </InputLabel>
                  <Select
                    labelId="to-doctor"
                  ...
                  >
                    ...
                    {doctors.map((doc) => (
                      <MenuItem key={doc._id} value={doc._id}>Dr. {doc.fullname}</MenuItem>    
                    ))}
                  </Select>
                </FormControl>
            </div>
