...
const remove = (doctor) =>{
    ...
    const OnRemoveDoctor = async () =>{
        await doctorService.removeDoctor(selcteDcotor)
        await getDoctors()
        handleClose()
    }
    ...
    return <>
        ...
        <Modal
            ...
            >
                ...
                <Box sx={style} className='update'>
                 ...
                 <div>
                    ...
                    <div className="input-continer">
                    <label>img url:</label>
                    <input id="imgUrl" type='url' placeholder="img url" value={selcteDcotor.imgUrl} required onChange={handleChange} />
                    </div>
                    <div className="input-continer">
            ...
            <div>
                ...
                <button className="acspet" onClick={OnRemoveDoctor}>Remove Doctor</button>
